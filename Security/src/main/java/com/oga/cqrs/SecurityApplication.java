...
public class SecurityApplication {
  ...
  @Autowired
  public SecurityApplication(UserCommandHandlers usercommandHandler, IUserQueryHandler userQueryHandler, GroupCommandHandlers groupCommandHandlers, IGroupQueryHandler groupQueryHandler, RoleCommandHandlers roleCommandHandlers , IRoleQueryHandler RoleQueryHandler) {
