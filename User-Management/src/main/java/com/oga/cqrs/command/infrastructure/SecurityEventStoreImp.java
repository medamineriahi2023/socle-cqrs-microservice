...
import com.oga.cqrs.command.events.user.EventStoreRepository;
...
@EnableMongoRepositories("com.oga.cqrs.command.events")
public class SecurityEventStoreImp implements EventStore {
    @Autowired
    ...
    public void saveEvents(String aggregateId, Iterable<BaseEvent> events, int expectedVersion) {
        ...
        // System.out.println(eventStoreRepository.findByAggregateIdentifier(aggregateId).getClass());
