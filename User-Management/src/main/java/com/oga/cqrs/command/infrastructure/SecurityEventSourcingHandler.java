package com.oga.cqrs.command.infrastructure;
...
/**
 * Handles event sourcing for the UserAggregate class.
 */
@ComponentScan(basePackages="com.oga.cqrsref.infrastructure")
@Service
public class SecurityEventSourcingHandler implements EventSourcingHandler {
    @Autowired
    ...
    /**
     * Retrieves the employe aggregate with the given id from the event store.
     *
     * @param id the id of the employe aggregate to retrieve
     * @return the employe aggregate with the given id
     */
