...
import com.oga.ged.command.rest.controller.CommandController;
...
public class FolderCommandControllerTest {
    ...
    void setUp() {
        ...
        ICommandHandler = new ICommandHandler(nodesApi,eventSourcingHandler);
    }
