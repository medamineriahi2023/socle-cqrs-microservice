...
import com.oga.ged.query.handlers.IFolderQueryHandler;
import com.oga.ged.query.queries.FindFoldersByParent;
...
public class FolderQueryTest {
    private Logger logger = LoggerFactory.getLogger(FolderQueryTest.class);
    private IFolderQueryHandler IFolderQueryHandler ;
