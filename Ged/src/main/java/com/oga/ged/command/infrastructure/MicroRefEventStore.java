...
import com.oga.ged.command.events.EventStoreRepository;
...
@Service
@EnableMongoRepositories("com.oga.ged.command.events")
...
/**
    ...
    public List<String> getAggregateIds() {
        ...
        if (eventStream == null || eventStream.isEmpty()) {
            throw new IllegalStateException(Constants.COULD_NOT_RETRIEVE_EVENT_STREAM);
        }
